...
#             full_transcript += f"**Interviewer:** {turn.interviewer_question}\n\n"
#             full_transcript += f"**Candidate:** {turn.candidate_response}\n\n"
...
#             full_transcript += f"**Evaluator Action Suggested:** {turn.evaluation.suggested_next_action}\n"
#             full_transcript += f"**Justification:** {turn.evaluation.brief_justification}\n\n"
#             full_transcript += "---\n\n"

#         user_prompt = f"Synthesize the following complete interview history into the final coaching report:\n\n{full_transcript}"
